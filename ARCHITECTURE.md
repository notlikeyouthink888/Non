...
```
┌──────────────────────────────────────────────────────┐
│  src/sections/*      الأقسام الثمانية (واجهة + منطق)  │
├──────────────────────────────────────────────────────┤
│  src/core/          store · dom · ui · fmt · idb      │
│                     media · usage · settings · native │
├──────────────────────────────────────────────────────┤
│  Capacitor Bridge                                     │
├──────────────────────────────────────────────────────┤
...
- `blobs` → صور وفيديو التمارين وأغراض الغرفة.
...
```bash
npm run check              # بناء + تصفّح ٣٣ تبويبًا + ١١ مسارًا تفاعليًا
...
التزام، مكان، عنصر إنتاجية، تمرين، بروتين، مصروف، غرض للغرفة، الإعدادات).
